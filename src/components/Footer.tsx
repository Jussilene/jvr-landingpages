...
export default function Footer() {
  return <footer>
    <div className="footer-grid">
      ...
      <div><strong>Atendimento</strong><p>{SITE.serviceArea}</p><a className="footer-whatsapp" href={whatsappUrl()} target="_blank" rel="noopener noreferrer"><WhatsAppIcon size={18}/>{SITE.WHATSAPP_DISPLAY}</a></div>
