...
import { ArrowLeft, ArrowRight, Check, ChevronDown, Headphones, Play, ShieldCheck, Sparkles } from 'lucide-react'
...
export default function TemplatePage() {
  ...
  return <div className={`demo theme-${item.palette} layout-${item.layout}`}>
    ...
    <nav className="demo-nav">
      ...
      <div><a href="#sobre">Sobre</a><a href="#servicos">Serviços</a><a href="#experiencia">Experiência</a><a href="#duvidas">Dúvidas</a><a href={contact} target="_blank" rel="noreferrer">Contato</a></div>
    </nav>

    <main>
      <section className="demo-hero" data-section="hero">
      ...
      <section className="demo-intro" id="sobre" data-section="apresentacao">
      ...
      <section className="demo-services" id="servicos" data-section="servicos">
        ...
        <div className="demo-service-grid">{item.services.map((service, index) =>
          <article key={service}><span>0{index+1}</span><h3>{service}</h3><p>Atendimento demonstrativo organizado para explicar possibilidades, escopo e próximos passos.</p><Check size={18}/></article>
        )}</div>
      </section>

      <section className="demo-benefits" data-section="beneficios">
      ...
      <section className={`demo-evidence evidence-${detail.proofType}`} id="experiencia" data-section="prova">
      ...
      <section className="demo-process" data-section="processo">
      ...
      <section className="demo-faq" id="duvidas" data-section="faq">
      ...
      <section className="demo-cta" data-section="cta">
